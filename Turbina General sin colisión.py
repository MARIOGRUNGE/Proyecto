...
def main():
    ...
    turbine_max_v = 50.0  # Velocidad angular máxima de la turbina
    turbine_acceleration = 0.05  # Ajusta la aceleración de la turbina aquí
    ...
    barra1 = Barra(100, 130, 300, 230, 5)
